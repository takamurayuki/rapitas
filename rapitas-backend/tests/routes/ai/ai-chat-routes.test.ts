...
const mockSendAIMessage = mock(() => Promise.resolve({ content: 'AI response', tokensUsed: 100 }));
const mockSendAIMessageStream = mock(() => Promise.resolve(new ReadableStream()));
...
function resetAllMocks() {
  ...
  mockGetConfiguredProviders.mockResolvedValue([{ provider: 'claude', isConfigured: true }]);
}
