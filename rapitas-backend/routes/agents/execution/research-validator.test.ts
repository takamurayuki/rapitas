/**
 * Tests for the research-mode helpers extracted from execute-post-handler.
 * Functions are imported from research-report-utils so tests verify the real
 * implementation rather than a hand-rolled mirror.
 */
