/**
 * SystemPrompts / DefaultPromptsCore
 *
 * Core (non-workflow) default system prompt seed records:
 * analysis, optimization, chat, agent, and general-purpose prompts.
 * Not responsible for workflow-role prompts (see default-prompts-workflow.ts).
 */

/** Single default prompt seed record. */
...
/**
 * Core default prompts for analysis, optimization, chat, agent, and general use.
 */
export const CORE_DEFAULT_PROMPTS: DefaultPromptRecord[] = [
  {
    key: 'task_analysis',
    name: 'タスク分析',
