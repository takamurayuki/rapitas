/**
 * workflow-helpers.guards.generated
 *
...
import type { WorkflowFileType } from './workflow-helpers';
import { VALID_FILE_TYPES } from './workflow-helpers';
...
export function isWorkflowFileType(s: unknown): s is WorkflowFileType {
  return typeof s === 'string' && (VALID_FILE_TYPES as readonly string[]).includes(s);
}
