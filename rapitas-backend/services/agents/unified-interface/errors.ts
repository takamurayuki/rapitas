 ...
 *
 * Defines agent error codes, error class, and error type guards.
 */
...
export enum AgentErrorCode {
  ...
  // Parallel execution errors (5xxx)
...
export class AgentError extends Error {
  ...
  /**
   * Returns the error as a serializable JSON object.
   */
...
/**
 * Checks whether the error is recoverable.
 */
