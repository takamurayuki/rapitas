      ...
      <div ref={contentRef} className="prose prose-zinc dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            ul: ({ children, ...props }) => (
              <ul
                className="list-disc pl-6 mb-4 space-y-1 text-zinc-700 dark:text-zinc-300"
                {...props}
              >
                {children}
              </ul>
            ...
            ol: ({ children, ...props }) => (
              <ol
                className="list-decimal pl-6 mb-4 space-y-1 text-zinc-700 dark:text-zinc-300"
                {...props}
              >
                {children}
              </ol>
            ...
            table: ({ children, ...props }) => (
              <div className="overflow-x-auto mb-4">
                <table
                  className="min-w-full border border-zinc-200 dark:border-zinc-700"
                  {...props}
                >
                  {children}
                </table>
