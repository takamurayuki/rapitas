        ...
        {showCodeInput && (
          ...
          >
            ...
            <select
              ...
              className="w-full px-2 py-1.5 bg-zinc-50 dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 rounded text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-indigo-400 mb-2"
            >
