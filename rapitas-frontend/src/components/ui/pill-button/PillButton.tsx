...
const COLOR_CLASSES: Record<PillButtonColor, { button: string; badge: string; icon: string }> = {
  indigo: {
    button:
...
export interface PillButtonProps {
  /** Lucide icon component shown inside the circular badge. */
  ...
  title?: string;
  ariaLabel?: string;
  /** Overrides the badge icon's color classes (e.g. a loading spinner that shouldn't be filled). */
