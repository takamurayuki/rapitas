...
import { Activity, AlertCircle, TrendingUp, CheckCircle, AlertTriangle, Database, Zap, HelpCircle } from 'lucide-react';
      ...
      {isLoading ? (
        ...
        <>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-amber-700 dark:text-amber-300">
                    ...
                    {hasErrors && '詳細は各プロバイダーの情報を確認してください。'}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 space-y-5">
            ...
            return (
              <div key={limit.provider} className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
                {/* Provider Header */}
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5">
                      <dataSourceConfig.icon className={`w-3.5 h-3.5 ${dataSourceConfig.color}`} />
                      <span className={`text-xs font-medium ${dataSourceConfig.color}`}>
                    ...
                    {/* Reliability */}
                    <div className="flex items-center gap-1.5">
                      <reliabilityConfig.icon className={`w-3.5 h-3.5 ${reliabilityConfig.color}`} />
                  ...
                  <div className="text-xs text-zinc-400 dark:text-zinc-500">
                    更新: {new Date(limit.lastUpdated).toLocaleTimeString('ja-JP', {
                      hour: '2-digit',
                      minute: '2-digit'
                    })}
                  </div>
                ...
                <div className="relative mb-3">
                  ...
                  <div className="absolute inset-0 flex items-center justify-between px-2">
                    ...
                    <span className={`text-xs font-medium ${percentage > 50 ? 'text-white' : usageColor}`}>
