    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      ...
      {Object.keys(stats.byCategory).length > 0 && (
        <div className="col-span-2 rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
          <h4 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">{t("byCategory")}</h4>
          <div className="flex flex-wrap gap-2">
            {Object.entries(stats.byCategory).map(([key, count]) => (
              <span key={key} className="text-xs px-2 py-1 rounded-full bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300">
      ...
      {Object.keys(stats.byStage).length > 0 && (
        <div className="col-span-2 rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
          <h4 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">{t("byStage")}</h4>
          <div className="flex flex-wrap gap-2">
