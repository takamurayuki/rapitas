...
const categories: Array<KnowledgeCategory | ""> = ["", "procedure", "fact", "pattern", "preference", "insight", "general"];
const stages: Array<ForgettingStage | ""> = ["", "active", "dormant", "archived"];
const validations: Array<ValidationStatus | ""> = ["", "pending", "validated", "rejected", "conflict"];
...
export function KnowledgeFilterPanel({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      >
        <option value="">{tc("all")} {t("category")}</option>
      ...
      <select
        ...
        className="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-700 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300"
      >
        <option value="">{tc("all")} {t("stage")}</option>
      ...
      <select
        ...
        className="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-700 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300"
      >
        <option value="">{tc("all")} {t("validation")}</option>
