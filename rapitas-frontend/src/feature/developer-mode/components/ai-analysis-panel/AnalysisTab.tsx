    ...
    return (
      <div className="space-y-3">
        <div className="p-3 bg-zinc-50 dark:bg-indigo-dark-800/50 rounded-lg">
          <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">概要</p>
          ...
          <div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {st.estimatedHours != null && st.estimatedHours > 0 && (
                        <span className="text-xs text-zinc-500">{st.estimatedHours}時間</span>
                      )}
                    </div>
                  </div>
                </div>
            ...
            {analysisApprovalId && !subtaskCreationSuccess && (
              <div className="mt-3 flex items-center justify-end gap-2">
                <span className="text-xs text-zinc-500">{selectedSubtasks.length}件選択中</span>
                <button
