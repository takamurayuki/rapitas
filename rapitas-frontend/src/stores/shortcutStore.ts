...
const DEFAULT_SHORTCUTS: ShortcutBinding[] = [
  { id: "newTask", label: "新規タスク作成", key: "N", meta: true, shift: false, ctrl: false },
  { id: "dashboard", label: "ダッシュボード", key: "D", meta: true, shift: false, ctrl: false },
  { id: "home", label: "ホーム（タスク一覧）", key: "H", meta: true, shift: false, ctrl: false },
  { id: "kanban", label: "カンバンビュー", key: "K", meta: true, shift: false, ctrl: false },
  { id: "calendar", label: "カレンダー", key: "L", meta: true, shift: false, ctrl: false },
  ...
  { id: "toggleAI", label: "ノート+AI機能", key: "E", meta: false, shift: false, ctrl: true },
];
...
interface ShortcutState {
  ...
  findDuplicate: (id: ShortcutId, binding: Pick<ShortcutBinding, "key" | "meta" | "shift" | "ctrl">) => ShortcutBinding | undefined;
}
