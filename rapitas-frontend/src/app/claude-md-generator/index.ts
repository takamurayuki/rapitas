...
export type { AppAnswers, AppProposal, DynamicItem, DocKind, GenerateResult } from './_types/types';
export { GENRES, SUB_GENRES, ELEMENTS, PLATFORMS, SCALES, PRIORITIES } from './_utils/constants';
export { GLOBAL_CSS } from './_utils/styles';
export { resolveLabels, proposeApps, generateClaudeMd } from './_utils/api';
