...
interface HomeToolbarProps {
  ...
  /** Whether any task exists at all. When false, only the empty-state create CTA is shown. */
  hasTasks: boolean;
...
export function HomeToolbar({
  ...
  return (
    <div className="mb-4 flex items-center justify-between">
      ...
      {/* Action group — auto-execution, create, and bulk. Hidden entirely when no
          task exists; the empty-state「タスクを作成」CTA becomes the sole entry point. */}
      {hasTasks && (
