        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="w-full sm:w-36">
            ...
            <input
              ...
              step="0.5"
              min="0"
              className="w-full rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-indigo-dark-900 px-3 py-1.5 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
              placeholder="0"
