...
/**
 * VocabDeckDetailClient
 *
 * One deck: add/edit/delete cards and launch the spaced-repetition review
 * session for the cards that are due. Client half of /vocabulary/[id] —
 * the server page.tsx owns generateStaticParams (static-export requirement).
 */
...
export default function VocabDeckDetailClient({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
