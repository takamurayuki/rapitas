            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">{t("runDate")}</th>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500">Status</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">{t("processed")}</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">{t("merged")}</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">{t("created")}</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-500">{t("duration")}</th>
                </tr>
              </thead>
              <tbody>
                {consolidationRuns.map((run) => (
                  <tr key={run.id} className="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td className="px-3 py-2 text-right text-gray-700 dark:text-gray-300">{run.entriesProcessed}</td>
                    <td className="px-3 py-2 text-right text-gray-700 dark:text-gray-300">{run.entriesMerged}</td>
                    <td className="px-3 py-2 text-right text-gray-700 dark:text-gray-300">{run.entriesCreated}</td>
